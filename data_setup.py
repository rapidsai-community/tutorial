...
def main():
    ...
    parser.add_argument('--pageviews', action='store_true', help='Download pageviews dataset')
    parser.add_argument('--nyc-parking', action='store_true', help='Download NYC parking violations dataset')
    parser.add_argument('--transactions', action='store_true', help='Download transactions dataset')
    parser.add_argument('--cover-type', action='store_true', help='Download and process cover type dataset')
    parser.add_argument('--har', action='store_true', help='Download and process HAR dataset')
